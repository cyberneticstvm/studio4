        ...
        <div class="swiper-container parallax-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="bg-img valign" data-background="{{ public_path().'/img/portfolio/interior/gal2.webp' }}" data-overlay-dark="6">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-10 offset-lg-1">
                                    <div class="caption hmone">
                                        <h5 class="thin custom-font">Interior Design</h5>
                                        <h1 data-splitting><a href="#0">Hospital</a>
                                        </h1>
                ...
                <div class="swiper-slide">
                    <div class="bg-img valign" data-background="{{ public_path().'/img/portfolio/interior/gal2/img1.webp' }}" data-overlay-dark="5">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-10 offset-lg-1">
                                    <div class="caption hmone">
                ...
                <div class="swiper-slide">
                    <div class="bg-img valign" data-background="{{ public_path().'/img/portfolio/interior/gal2/img2.webp' }}" data-overlay-dark="5">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-10 offset-lg-1">
                                    <div class="caption hmone">
