@extends("base")
@section("content")
<header class="pages-header work-header bg-img bg-dark valign" data-background="{{ public_path().'/img/portfolio/architecture/GAL1.webp' }}" data-overlay-light="7">
    <div class="container">
            ...
            <div class="gallery twsty inf-lit full-width">
                ...
                <div class="items hot three-column mt-50">
                    ...
                    <div class="info mt-10">
                        <h5 class="text-dark">Architectural Design</h5>
